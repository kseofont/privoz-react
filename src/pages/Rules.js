        ...
        <div className="col-12 col-sm-9 order-2 order-sm-1 d-flex flex-column justify-content-center align-items-center text-center">
          ...
          <div className="card">
            <div className="card-body">
              <h5 className="card-title">Настольная игра "Привоз" - версия 3(условно текущая)</h5>
              ...
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item">Карты товаров (фрукты, овощи, мясо, рыба и др.)</li>
                <li className="list-group-item">Карты событий (позитивные и негативные)</li>
                <li className="list-group-item">Фигурки продавцов (по 3 на каждого игрока)</li>
                <li className="list-group-item">Монеты</li>
                <li className="list-group-item">Карты покупателей</li>
                <li className="list-group-item">Фишки для обозначения выбранных секторов</li>
              </ul>
              <p className="card-text">
                <strong>Ход раунда:</strong>
              </p>
              <ol>
                <li>
                  Выбор продавца (по очереди с начала). У каждого продавца своя способность и бонус
                  в любимом секторе. Максимум 3 товара на одного продавца.
                </li>
                <li>
                  Закупка товаров на оптовом рынке. Количество товаров зависит от числа продавцов:
                  например, при 2 игроках выкладывается 2 случайных товара из овощей и фруктов плюс
                  8 любых случайных товаров. Каждый раунд оставшиеся товары убираются в колоду.
                </li>
                <li>Выбор сектора для каждого продавца (по очереди с начала).</li>
                <li>
                  Получение 1 случайной карты события на руку (позитивной или негативной).
                  Негативные можно использовать против других за монеты, позитивные — сохранять за
                  монеты на следующий раунд.
                </li>
                <li>Появляется 1 случайная карта события на всех игроков (глобальное событие).</li>
                <li>
                  Появление покупателей: у каждого покупателя по 3 товара (овощи и фрукты всегда
                  есть, вероятность других товаров ниже). Количество покупателей: на 1 больше, чем
                  количество продавцов.
                </li>
                <li>Фаза продаж и прокорма.</li>
              </ol>
            </div>
          </div>
          {/* Версия 1 */}
          <div className="card mb-4">
            <div className="card-body">
              ...
              <ol className="list-group list-group-numbered">
                <li className="list-group-item">
                  <strong>Определение положения на карте:</strong> Игроки по очереди выбирают места
                  для своих продавцов в зонах. Стоимость продавцов: 1 бесплатный, 2 - 10 монет, 3 -
                  20 и т.д.
                </li>
                <li className="list-group-item">
                  <strong>Специальные карты:</strong> Игроки получают Специальные карты каждый раунд
                  и они бывают 2 видов:
                  <ul>
                ...
                <li className="list-group-item">
                  <strong>Открытие негативной карты:</strong> Все игроки получают по 1 негативной
                  карте (штрафы, снижение продаж) или она одна разыгрывается на всех.
                </li>
                <li className="list-group-item">
                ...
                <li className="list-group-item">
                  ...
                  увеличенной в зависимости от спроса или действия спец карт. Нелегальная торговля
                  может привести к штрафам, но она очень выгодна.
                </li>
                <li className="list-group-item">
                  <strong>Прокорм:</strong> Игроки платят 1 монету за каждого продавца. Активируются
                  эффекты спецкарт.
                </li>
              </ol>
              <p className="card-text mt-4">
            ...
            <div className="card-body">
              ...
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item">
                  ...
                  молоко, лук, помидор, свинина, шляпа; розыгрыш продажи товара по очереди у каждого
                  игрока есть меняющаяся очередность, номер 1 — ...)
                </li>
              </ul>
              <p className="card-text mt-4">
                <strong>Ход игры:</strong>
              ...
              <ol className="list-group list-group-numbered">
                ...
                <li className="list-group-item">
                  ...
                  <ul>
                    <li>
                      Ивенты положительные — с руки, отрицательные — из колоды, вместо дней недели.
                    </li>
              ...
              <div className="alert alert-warning mt-4">
                <strong>Настольная игра "Привоз"</strong> — это динамичная и азартная игра, которая
                позволит вам испытать себя в роли успешного предпринимателя!
              </div>
            </div>
          </div>
        </div>
